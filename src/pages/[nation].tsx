...
export default function Nation({ nation }: NationProps) {
  return (
    <>
        ...
        >
          ...
          <Box>
            ...
            >
              cidades +100
              <Tooltip
                label="Número de cidades entre as 100 mais visitadas"
                placement="bottom"
              >
                <InfoOutlineIcon
                  ml="5px"
                  w={["10px", "16px"]}
                  h={["10px", "16px"]}
                  color={theme.colors.dark.info50}
                />
              </Tooltip>
            </Text>
          </Box>
      ...
      <Box maxWidth={1560} mx={["1rem","8rem"]} mt={["1rem","5rem"]}>
        <Heading
          as="h2"
          fontWeight="500"
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  let nation_filter = json.find((element) => element.name == nation);
  return {
    props: {
